<div>
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center space-x-3">
            <!--[if BLOCK]><![endif]--><?php if(count($selectedMaterials) > 0): ?>
                <span class="text-sm font-semibold text-gray-700">
                    <?php echo e(count($selectedMaterials)); ?> terpilih
                </span>
                <button 
            ...
            <a href="<?php echo e(route('teaching-materials.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition flex items-center space-x-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="space-y-6">
        <!-- Select All Header -->
        <!--[if BLOCK]><![endif]--><?php if($materials->count() > 0): ?>
        ...
        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $groupedMaterials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $categoryMaterials): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-lg shadow">
                <div class="px-6 py-4 bg-gray-50 border-b">
                    <h2 class="text-lg font-semibold text-gray-800">
                        📂 <?php echo e($categoryMaterials->first()->category_label); ?> (<?php echo e($categoryMaterials->count()); ?> dokumen)
                    </h2>
                </div>
                
                <div class="p-6 space-y-4">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categoryMaterials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition">
                            <div class="flex items-start space-x-3">
                                <!-- Checkbox (only for draft items) -->
                                <!--[if BLOCK]><![endif]--><?php if($material->status === 'draft' && ($material->created_by === auth()->id() || auth()->user()->canManageUsers())): ?>
                                    <div class="pt-1">
                                        <input 
                                            type="checkbox" 
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex justify-between items-start mb-2">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($material->version_number > 1 || $material->hasRevisions()): ?>
                                                <span class="px-2 py-1 text-xs font-semibold rounded bg-indigo-100 text-indigo-800">
                                                    <?php echo e($material->version_label); ?>
                                        ...
                                        <span class="px-3 py-1 text-xs font-semibold rounded-full 
                                            <?php if($material->status === 'approved'): ?> bg-green-100 text-green-800
                                            <?php elseif($material->status === 'pending_approval'): ?> bg-yellow-100 text-yellow-800
                                            <?php elseif($material->status === 'rejected'): ?> bg-red-100 text-red-800
                                            <?php else: ?> bg-gray-100 text-gray-800
                                            <?php endif; ?>">
                                            <?php echo e($material->status_label); ?>
                                    ...
                                    <div class="text-sm text-gray-600 mb-2">
                                        <!--[if BLOCK]><![endif]--><?php if($material->subject): ?>
                                            <span><?php echo e($material->subject->name); ?></span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <!--[if BLOCK]><![endif]--><?php if($material->grade): ?>
                                            • <span>Kelas <?php echo e($material->grade); ?></span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <!--[if BLOCK]><![endif]--><?php if($material->phase): ?>
                                            • <span>Fase <?php echo e($material->phase); ?></span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <!--[if BLOCK]><![endif]--><?php if($material->semester): ?>
                                            • <span>Semester <?php echo e($material->semester); ?></span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>

                                    <div class="text-sm text-gray-600 mb-3">
                                        👤 <?php echo e($material->creator->name); ?> • 
                                        📅 <?php echo e($material->created_at->format('d M Y')); ?>

                                        <!--[if BLOCK]><![endif]--><?php if($material->file_type === 'link'): ?>
                                            • 🔗 Link Eksternal
                                        <?php else: ?>
                                            • 📎 <?php echo e(strtoupper($material->file_type)); ?> (<?php echo e($material->file_size_formatted); ?>)
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>

                                    <!-- Tags -->
                                    <!--[if BLOCK]><![endif]--><?php if($material->tags): ?>
                                        <div class="flex flex-wrap gap-1 mb-3">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $material->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <!-- Dimensions -->
                                    <!--[if BLOCK]><![endif]--><?php if(count($material->selected_dimensions) > 0): ?>
                                        <div class="flex flex-wrap gap-1 mb-3">
                                            <span class="text-xs text-gray-600">🎯 Dimensi:</span>
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $material->selected_dimensions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dimension): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="text-xs text-gray-500 mb-3">
                                        👁️ <?php echo e($material->view_count); ?> views • 
                                        ⬇️ <?php echo e($material->download_count); ?> downloads
                                    </div>

                                    <!-- Actions -->
                                    <div class="flex items-center space-x-2">
                                        <a href="<?php echo e(route('teaching-materials.show', $material->id)); ?>" 
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($material->version_number > 1 || $material->hasRevisions()): ?>
                                            <a href="<?php echo e(route('teaching-materials.versions', $material->id)); ?>" 
                                               class="px-3 py-1 bg-indigo-600 hover:bg-indigo-700 text-white text-sm rounded transition">
                                                📜 History
                                            </a>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        
                                        <!--[if BLOCK]><![endif]--><?php if($material->created_by === auth()->id() || auth()->user()->canManageUsers()): ?>
                                            
                                            <!--[if BLOCK]><![endif]--><?php if($material->canBeEdited()): ?>
                                                <a href="<?php echo e(route('teaching-materials.edit', $material->id)); ?>" 
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($material->canCreateRevision()): ?>
                                                <button 
                                                    wire:click="openRevisionModal(<?php echo e($material->id); ?>)"
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($material->canBeWithdrawn()): ?>
                                                <button 
                                                    wire:click="withdrawMaterial(<?php echo e($material->id); ?>)"
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($material->status === 'draft'): ?>
                                                <button 
                                                    wire:click="delete(<?php echo e($material->id); ?>)"
                                                    wire:confirm="Hapus perangkat ajar '<?php echo e($material->title); ?>'?"
    ...
    <!-- Pagination -->
    <!--[if BLOCK]><![endif]--><?php if($materials->hasPages()): ?>
        <div class="mt-6">
            ...
            <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
                ...
                <div class="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                    <p class="text-sm font-semibold text-red-800">
                        ⚠️ Anda akan menghapus <strong><?php echo e(count($selectedMaterials)); ?> perangkat ajar</strong>
                    </p>
...
<?php /**PATH C:\Users\DMCenter\Music\SPMB2\E-KALDIK\resources\views/livewire/teaching-material/index.blade.php ENDPATH**/ ?>