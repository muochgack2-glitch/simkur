    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="text-center mb-8">
            ...
            <div class="flex items-center justify-center space-x-2 mt-3">
                ...
                <span class="px-3 py-1 bg-white/20 rounded-full text-xs text-white font-medium">AKL</span>
                <span class="px-3 py-1 bg-white/20 rounded-full text-xs text-white font-medium">BUSANA</span>
            </div>
        </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        <input
                            ...
                            required
                        >
                        <button type="button" onclick="var p=document.getElementById('password');var o=document.getElementById('eyeO');var c=document.getElementById('eyeC');if(p.type==='password'){p.type='text';o.style.display='none';c.style.display='block'}else{p.type='password';o.style.display='block';c.style.display='none'}" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600">
                            <svg id="eyeO" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                            <svg id="eyeC" class="w-5 h-5" style="display:none" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
                        </button>
                    </div>
                    @error('password')
                        <p class="mt-2 text-sm text-red-600 flex items-center">
