...
<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
    <div class="p-6">
        <h3 class="mb-6 text-lg font-semibold text-gray-900 ">📊 Detail Skor Gaya Belajar Anda</h3>
                ...
                <div>
                    <div class="mb-2 flex items-center justify-between">
                        ...
                        <div class="text-right">
                            <span class="text-lg font-bold text-gray-900 ">{{ $style['score'] }}</span>
                            <span class="ml-2 text-sm text-gray-700 ">({{ round($style['percentage']) }}%)</span>
                        </div>
                    </div>
...
<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
    <div class="p-6">
        <div class="mb-4 flex items-center">
            ...
            <h3 class="text-lg font-semibold text-gray-900 ">💡 Tips Belajar untuk Anda</h3>
        </div>
        ...
        <div class="grid gap-3 sm:grid-cols-2">
            @foreach($profile->recommendations['tips'] as $tip)
                <div class="flex items-start rounded-lg border border-gray-200 p-4 ">
...
<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
    <div class="p-6">
        <div class="mb-4 flex items-center">
            ...
            <h3 class="text-lg font-semibold text-gray-900 ">📚 Metode Belajar yang Disarankan</h3>
        </div>
    ...
    <div class="overflow-hidden border-2 border-dashed border-purple-300 bg-purple-50 shadow-sm sm:rounded-lg">
        <div class="p-6">
            <div class="flex items-start">
                <svg class="mr-3 h-6 w-6 flex-shrink-0 text-purple-600 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
