...
<div x-data="{ modalImg: null, modalAnswer: null, modalName: '', showRevision: false }">
    ...
    <div x-cloak x-show="modalImg" @click.self="modalImg=null" @keydown.escape.window="modalImg=null"
        ...
        <div style="position:relative;background:white;border-radius:16px;max-width:672px;width:100%;padding:16px;">
        ...
        <div style="background:white;border-radius:16px;max-width:600px;width:100%;max-height:80vh;display:flex;flex-direction:column;overflow:hidden;">
            <div style="padding:16px 20px;border-bottom:1px solid #e5e7eb;display:flex;justify-content:space-between;align-items:center;">
                <div>
                    ...
                    <p x-text="modalName" style="font-size:12px;color:#6b7280;"></p>
                </div>
                <button @click="modalAnswer=null" style="width:32px;height:32px;background:#f3f4f6;border-radius:50%;border:none;cursor:pointer;font-weight:bold;">&#10005;</button>
            </div>
    ...
    {{-- REVISION MODAL — wire:click & wire:model aman di sini (Livewire scan seluruh DOM) --}}
    <div x-cloak x-show="showRevision" @keydown.escape.window="showRevision=false"
        style="position:fixed;inset:0;z-index:50;background:rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;padding:16px;">
        <div @click.stop style="background:white;border-radius:16px;box-shadow:0 25px 50px rgba(0,0,0,0.25);max-width:480px;width:100%;overflow:hidden;">
            ...
            <div style="padding:20px;">
                ...
                <div style="display:flex;gap:10px;margin-top:16px;">
                    ...
                    <button wire:click="requestRevision" @click="showRevision=false"
    ...
    <div class="ag-mobile space-y-4">
        ...
        <div class="bg-white rounded-xl border p-4 space-y-3"
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;">
                ...
                {{-- Set Livewire property dari sini (DALAM component DOM) lalu buka modal Alpine --}}
                <button
                    @click="$wire.set('revisionSubmissionId', {{ $sub->id }}); $wire.set('revisionNote', ''); showRevision=true"
                ...
                <tbody class="divide-y">
                    ...
                    <tr style="{{ $sub->revision_requested ? 'background:#fffbeb;' : '' }}">
                        ...
                        <td class="py-3 px-4 text-center" style="white-space:nowrap;">
                            ...
                            {{-- $wire.set() dipanggil dari DALAM tabel (component DOM) — aman --}}
                            <button
                                @click="$wire.set('revisionSubmissionId', {{ $sub->id }}); $wire.set('revisionNote', ''); showRevision=true"
