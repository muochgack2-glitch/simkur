            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                        <div class="flex-1">
                            <label class="mb-2 block text-sm font-medium text-gray-900 ">Pilih Kelas</label>
                        ...
                        <div class="flex-1">
                            <label class="mb-2 block text-sm font-medium text-gray-900 ">Pilih Jurusan</label>
                        ...
                        <div class="flex-1">
                            <label class="mb-2 block text-sm font-medium text-gray-900 ">Pilih Semester</label>
