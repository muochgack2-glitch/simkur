            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="rounded-lg bg-white p-6 shadow-sm ">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-800 ">Sudah Selesai</p>
                ...
                <div class="rounded-lg bg-white p-6 shadow-sm ">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-800 ">Belum Selesai</p>
                ...
                <div class="rounded-lg bg-white p-6 shadow-sm ">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900 ">{{ round($completionPercentage) }}%</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="flex gap-3">
                            <select wire:model.live="filterGrade"
                                    class="rounded-lg border border-gray-300 bg-white p-2 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 ">
