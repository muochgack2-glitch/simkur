@if($statistics['total_students'] > 0 && isset($diagnosticAssessment))
    ...
    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800">
            <div class="text-center">
                <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Perlu Pendampingan</p>
        ...
        <div class="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800">
            <div class="text-center">
                <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Sangat Baik</p>
    ...
    @if(!empty($statistics['average_aspects']))
        <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
            <div class="p-6">
                <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">📊 Rata-rata Kesiapan Belajar per Aspek - Kelas {{ $selectedGrade }}</h3>
    ...
    @if(!empty($statistics['category_distribution']))
        <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
            <div class="p-6">
                <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">📈 Distribusi Kategori Kesiapan Belajar</h3>
                
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    @php
                        $categories = [
                            'sangat_baik' => ['label' => 'Sangat Baik', 'icon' => '🌟', 'bg' => 'bg-green-100', 'text' => 'text-green-800', 'dark_bg' => 'dark:bg-green-900/30', 'dark_text' => 'dark:text-green-300'],
                            'baik' => ['label' => 'Baik', 'icon' => '👍', 'bg' => 'bg-blue-100', 'text' => 'text-blue-800', 'dark_bg' => 'dark:bg-blue-900/30', 'dark_text' => 'dark:text-blue-300'],
                            'cukup' => ['label' => 'Cukup', 'icon' => '😊', 'bg' => 'bg-yellow-100', 'text' => 'text-yellow-800', 'dark_bg' => 'dark:bg-yellow-900/30', 'dark_text' => 'dark:text-yellow-300'],
                            'perlu_pendampingan' => ['label' => 'Perlu Pendampingan', 'icon' => '💪', 'bg' => 'bg-red-100', 'text' => 'text-red-800', 'dark_bg' => 'dark:bg-red-900/30', 'dark_text' => 'dark:text-red-300'],
                        ];
                    @endphp
...
@else
    ...
    <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
        <div class="p-12 text-center">
            ...
            <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">Belum Ada Data Diagnostik</h3>
