                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-3 py-3 text-center">
                            <button wire:click="saveScores({{ $p->id }})" class="px-3 py-1.5 bg-green-600 hover:bg-green-700 text-white rounded-lg text-xs font-semibold shadow-sm hover:shadow transition-all">💾 Simpan</button>
                        </td>
                    </tr>
                    @empty
