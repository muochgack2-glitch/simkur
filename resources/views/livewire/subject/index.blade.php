<div>
    ...
    <div class="mb-6 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('subjects.export') }}?search={{ urlencode($search) }}&filterStatus={{ $filterStatus }}"
               class="inline-flex items-center gap-1.5 rounded-lg border border-green-600 px-4 py-2 text-sm font-medium text-green-700 hover:bg-green-50 transition-colors"
