<div>
    ...
    <!-- Flash Messages -->
    @if (session('success'))
        <div class="mb-5 p-3 bg-green-50 border border-green-200 rounded-xl flex items-center gap-2 text-sm text-green-700">
    ...
    @if (session('error'))
        <div class="mb-5 p-3 bg-red-50 border border-red-200 rounded-xl flex items-center gap-2 text-sm text-red-600">
    ...
    <form wire:submit="login" class="space-y-5" x-data="{ showPassword: false }">
        ...
        <div>
            ...
            <div class="relative">
                ...
                >
                    ...
                    <svg x-show="showPassword" x-cloak class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.8">
        ...
        <button
            ...
            class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5 px-4 rounded-xl transition duration-200 flex items-center justify-center gap-2 shadow-lg shadow-blue-500/30 transform hover:scale-[1.02]"
        >
