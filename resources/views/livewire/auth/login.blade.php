<div>
    <div class="text-center mb-6">
        ...
        <p class="text-sm text-gray-800">Silakan login untuk mengakses sistem</p>
    </div>
        ...
        <div>
            <label for="username" class="block text-sm font-semibold text-gray-700 mb-2">
                <span class="flex items-center">
                    <svg class="w-4 h-4 mr-1.5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
