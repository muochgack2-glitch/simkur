<div>
    <div class="mb-6">
        <a href="{{ route('users.index') }}" class="text-gray-800 hover:text-gray-900 flex items-center">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-800 ">Isi form di bawah untuk menambahkan pengguna baru</p>
    </div>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                @if($role === 'guru')
                    <div>
                        ...
                        @error('nip_nuptk') <span class="text-sm text-red-600 ">{{ $message }}</span> @enderror
                    </div>
                @endif
                ...
                @if($role === 'siswa')
                    ...
                    <div>
                        <label for="nis" class="block mb-2 text-sm font-medium text-gray-900 ">
                            NIS
                        </label>
                ...
                <div>
                    ...
                    <div class="flex">
                        <input type="text" id="username" wire:model="username"
                               class="flex-1 bg-white border border-gray-300 text-gray-900 text-sm rounded-l-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                               placeholder="username">
                        <button type="button" wire:click="generateUsername"
                                class="px-4 bg-gray-200 hover:bg-gray-300 rounded-r-lg ">
                ...
                @if($role === 'siswa')
                    <div>
                        ...
                        @error('no_hp') <span class="text-sm text-red-600 ">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label for="parent_name" class="block mb-2 text-sm font-medium text-gray-900 ">
                            Nama Orang Tua
                        </label>
                        <input type="text" id="parent_name" wire:model="parent_name"
                               class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                               placeholder="Nama orang tua/wali">
                        @error('parent_name') <span class="text-sm text-red-600 ">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label for="parent_phone" class="block mb-2 text-sm font-medium text-gray-900 ">
                            No HP Orang Tua
                        </label>
                        <input type="text" id="parent_phone" wire:model="parent_phone"
                               class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                               placeholder="08123456789">
                        @error('parent_phone') <span class="text-sm text-red-600 ">{{ $message }}</span> @enderror
                    </div>
                @endif
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-700">Default: password</p>
                ...
                @if($role === 'siswa')
                    ...
                    <div class="md:col-span-2">
                        <label for="class_id" class="block mb-2 text-sm font-medium text-gray-900 ">
                        ...
                        @error('class_id') <span class="text-sm text-red-600 ">{{ $message }}</span> @enderror
                    </div>

                    <!-- PKL & Teaching Factory -->
                    <div class="md:col-span-2">
                        <label class="block mb-2 text-sm font-medium text-gray-900 ">Program Khusus</label>
                        <div class="flex items-center space-x-6">
                            <div class="flex items-center">
                                <input id="is_pkl" type="checkbox" wire:model="is_pkl"
                                       class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                                <label for="is_pkl" class="ml-2 text-sm font-medium text-gray-900 ">PKL (Praktik Kerja Lapangan)</label>
                            </div>
                            <div class="flex items-center">
                                <input id="is_teaching_factory" type="checkbox" wire:model="is_teaching_factory"
                                       class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                                <label for="is_teaching_factory" class="ml-2 text-sm font-medium text-gray-900 ">Teaching Factory</label>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                @if($role === 'guru')
                    <div>
                        ...
                        <input type="number" id="beban_mengajar" wire:model="beban_mengajar" min="0" max="40"
                               class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                               placeholder="24">
                        @error('beban_mengajar') <span class="text-sm text-red-600 ">{{ $message }}</span> @enderror
                    </div>
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex items-center">
                                <input id="major_mplb" type="checkbox" value="MPLB" wire:model="taught_majors"
                                       class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                                <label for="major_mplb" class="ml-2 text-sm text-gray-900 ">MPLB</label>
                            </div>
                            <div class="flex items-center">
                                <input id="major_akl" type="checkbox" value="AKL" wire:model="taught_majors"
                                       class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                                <label for="major_akl" class="ml-2 text-sm text-gray-900 ">AKL</label>
                            </div>
                            <div class="flex items-center">
                                <input id="major_busana" type="checkbox" value="BUSANA" wire:model="taught_majors"
                                       class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                                <label for="major_busana" class="ml-2 text-sm text-gray-900 ">BUSANA</label>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach($subjects as $subject)
                                    <div class="flex items-center">
                                        <input id="subject_{{ $subject->id }}" type="checkbox" value="{{ $subject->id }}" wire:model="subject_ids"
                                               class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                                        <label for="subject_{{ $subject->id }}" class="ml-2 text-sm text-gray-900 ">
                                            {{ $subject->name }}
                                        </label>
                                    </div>
                                @endforeach
