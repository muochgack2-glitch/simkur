<div>
    <div class="mb-6">
        <a href="{{ route('classes.index') }}" class="text-gray-600 hover:text-gray-900 flex items-center">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Perbarui informasi kelas</p>
    </div>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="name" wire:model="name" 
                           ...
                           readonly>
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Nama kelas dibuat otomatis berdasarkan tingkat dan jurusan</p>
                    @error('name') <span class="text-sm text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                </div>

                <!-- Tahun Ajaran -->
                <div>
                    <label for="academic_year_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    ...
                    @error('academic_year_id') <span class="text-sm text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                </div>
                ...
                <div>
                    ...
                    @error('homeroom_teacher_id') <span class="text-sm text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Saat ini: {{ $class->getStudentCount() }} siswa</p>
                    @error('capacity') <span class="text-sm text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                </div>
                ...
                <div>
                    ...
                    @error('room') <span class="text-sm text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                </div>
